...
export default async function UsersAdminPage() {
  ...
  return <main className="admin-page"><header className="admin-head"><div><p className="eyebrow">Administrace přístupu</p><h1>Uživatelé MP Knowledge Base</h1><p>Přístup k celé KB získá uživatel až po schválení.</p></div><Link className="secondary-button" href="/">Zpět do KB</Link></header>
