...
export function AccessShell({access}:{access:AccessState}) {
  if(access.status==='anonymous')return <main className="access-page"><section className="access-card">
    <div className="brand access-brand"><div className="brand-mark" aria-hidden="true"><span/><span/><span/></div><div><strong>MP Knowledge Base</strong><small>SDM</small></div></div>
