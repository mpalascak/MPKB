...
vm.runInContext(fs.readFileSync('dist/app.js','utf8')+'\n globalThis.api={products,glossary,powerVaultQuestions,productTrainingView,productTrainingQuestions,productTrainingChapters,annotateTrainingText,state};',context);
const a=context.api;
